/*
  Example: ESP32_I2C_icode_slix2_read_write_test
  Bus: I2C
  ...
  Usage:
    1. Wire the ST25R3916 board for I2C on an ESP32 Dev Module.
...
void printSystemInfoSummary(const NfcvSystemInfo &info)
{
  ...
  Serial.println();
  Serial.println("=== ISO15693 / ICODE Read/Write Test (I2C) ===");
  Serial.print("UID: ");
  Serial.println(uid);
...
void setup()
{
  ...
  Serial.println("ESP32 I2C ICODE SLIX2 read/write test");
  Serial.print("SDA=");
