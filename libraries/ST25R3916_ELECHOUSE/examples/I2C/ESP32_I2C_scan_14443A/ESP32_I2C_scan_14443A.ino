/*
  ...
  Cards: ISO14443A
  Goal: First end-to-end I2C card detection example for ESP32.
  Common failures: missing pull-ups, wrong SDA/SCL pins, IRQ not connected, assuming 400kHz is stable too early.
*/
...
void setup()
{
  ...
  Serial.println("ESP32 I2C ISO14443A scanner");
  Serial.print("SDA=");
