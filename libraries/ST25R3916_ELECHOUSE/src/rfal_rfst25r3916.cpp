    ...
    case RFAL_TXRX_STATE_TX_TRANSMIT:   /*  PRQA S 2003 # MISRA 16.3 - Intentional fall through */
      ...
      if (rfalIsModePassiveListen(gRFAL.mode)) {
        if (!rfalIsExtFieldOn() &&
            ...
            gRFAL.Lm.state != RFAL_LM_STATE_ACTIVE_Ax) {
...
ReturnCode RfalRfST25R3916Class::rfalListenStart(uint32_t lmMask, const rfalLmConfPA *confA, const rfalLmConfPB *confB, const rfalLmConfPF *confF, uint8_t *rxBuf, uint16_t rxBufLen, uint16_t *rxLen)
{
  ...
  if (((lmMask & RFAL_LM_MASK_NFCA) == 0U) || (confA == NULL) || (rxBuf == NULL) || (rxLen == NULL)) {
    return ERR_PARAM;
  }
  ...
  pPTMem = &pPTMem[RFAL_NFCID1_TRIPLE_LEN];

  ST_MEMCPY(pPTMem, confA->SENS_RES, RFAL_LM_SENS_RES_LEN);
  pPTMem = &pPTMem[RFAL_LM_SENS_RES_LEN];
  ...
  *(pPTMem++) = (confA->SEL_RES & ~RFAL_LM_NFCID_INCOMPLETE);
  ...
  gRFAL.Lm.mdReg  |= (ST25R3916_REG_MODE_targ_targ |
                      ST25R3916_REG_MODE_om3 |
                      ST25R3916_REG_MODE_om0 |
                      ST25R3916_REG_MODE_nfc_ar_off);
  gRFAL.Lm.mdIrqs |= (ST25R3916_IRQ_MASK_WU_A |
  ...
  *gRFAL.Lm.rxLen   = 0;
  ...
  st25r3916ChangeRegisterBits(ST25R3916_REG_PASSIVE_TARGET,
  ...
  return rfalListenSetState(RFAL_LM_STATE_POWER_OFF);
}
...
ReturnCode RfalRfST25R3916Class::rfalListenSleepStart(rfalLmState sleepSt, uint8_t *rxBuf, uint16_t rxBufLen, uint16_t *rxLen)
{
  ...
  st25r3916ClearAndEnableInterrupts((ST25R3916_IRQ_MASK_NFCT |
...
ReturnCode RfalRfST25R3916Class::rfalListenStop(void)
{
  ...
  st25r3916DisableInterrupts((ST25R3916_IRQ_MASK_RXE_PTA |
                              ST25R3916_IRQ_MASK_WU_F |
                              ST25R3916_IRQ_MASK_WU_A |
                              ST25R3916_IRQ_MASK_WU_A_X |
                              ST25R3916_IRQ_MASK_RFU2 |
                              ST25R3916_IRQ_MASK_OSC));
  st25r3916GetInterrupt((ST25R3916_IRQ_MASK_RXE_PTA |
                         ST25R3916_IRQ_MASK_WU_F |
                         ST25R3916_IRQ_MASK_WU_A |
                         ST25R3916_IRQ_MASK_WU_A_X |
                         ST25R3916_IRQ_MASK_RFU2 |
  ...
  do {
    ...
    switch (newState) {
      ...
      case RFAL_LM_STATE_IDLE:
        if (!st25r3916CheckReg(ST25R3916_REG_OP_CONTROL, ST25R3916_REG_OP_CONTROL_en, ST25R3916_REG_OP_CONTROL_en)) {
          ...
          if (!st25r3916CheckReg(ST25R3916_REG_AUX_DISPLAY, ST25R3916_REG_AUX_DISPLAY_osc_ok, ST25R3916_REG_AUX_DISPLAY_osc_ok)) {
            if (st25r3916WaitForInterruptsTimed(ST25R3916_IRQ_MASK_OSC, 10U) == 0U) {
              ret = ERR_IO;
              break;
            }
          }
      ...
      case RFAL_LM_STATE_ACTIVE_A:
        ...
        st25r3916GetInterrupt((ST25R3916_IRQ_MASK_PAR |
                               ST25R3916_IRQ_MASK_CRC |
                               ST25R3916_IRQ_MASK_ERR2 |
                               ST25R3916_IRQ_MASK_ERR1));
...
ReturnCode RfalRfST25R3916Class::rfalRunListenModeWorker(void)
{
  ...
  switch (gRFAL.Lm.state) {
    ...
    case RFAL_LM_STATE_IDLE:
      irqs = st25r3916GetInterrupt((ST25R3916_IRQ_MASK_NFCT |
      ...
      if ((irqs & ST25R3916_IRQ_MASK_NFCT) != 0U) {
        ...
        gRFAL.Lm.brDetected = (rfalBitRate)newBr;
      }
      ...
      if (((irqs & ST25R3916_IRQ_MASK_EOF) != 0U) && (!gRFAL.Lm.dataFlag)) {
        ...
        irqs = st25r3916GetInterrupt((ST25R3916_IRQ_MASK_RXE |
                                      ST25R3916_IRQ_MASK_EOF |
                                      ST25R3916_IRQ_MASK_CRC |
                                      ST25R3916_IRQ_MASK_PAR |
                                      ST25R3916_IRQ_MASK_ERR2 |
    ...
    case RFAL_LM_STATE_ACTIVE_Ax:
      ...
      if ((irqs & ST25R3916_IRQ_MASK_EOF) != 0U) {
        ...
        irqs |= st25r3916GetInterrupt((ST25R3916_IRQ_MASK_PAR |
                                       ST25R3916_IRQ_MASK_CRC |
                                       ST25R3916_IRQ_MASK_ERR2 |
                                       ST25R3916_IRQ_MASK_ERR1));
        *gRFAL.Lm.rxLen = st25r3916GetNumFIFOBytes();
    ...
    case RFAL_LM_STATE_SLEEP_A:
      ...
      if (((irqs & ST25R3916_IRQ_MASK_EOF) != 0U) && (!gRFAL.Lm.dataFlag)) {
        rfalListenSetState(RFAL_LM_STATE_POWER_OFF);
      } else if (((irqs & ST25R3916_IRQ_MASK_RXE_PTA) != 0U) && (gRFAL.Lm.brDetected == RFAL_BR_106)) {
        st25r3916ReadRegister(ST25R3916_REG_PASSIVE_TARGET_STATUS, &tmp);
